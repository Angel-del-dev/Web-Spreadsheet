class SpreadsheetGlobalState {
    ...
    constructor({ Node, MaxPages, Rows, Columns, Data, _append_styles, _fetch_data }) {
        this.#D_Node = Node;
    ...
    #_cell_load_properies({_cell_node, cell}) {
        ...
        // Attibutes
        if(cell._type !== undefined) _cell_node.setAttribute('cell-type', cell._type);
        // Styles
    ...
    _select_cell(_node) {
        if(this.#D_Focused_Cell !== null) this.#D_Focused_Cell.classList.remove('active');
